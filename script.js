...
continueBtn.addEventListener("click", () => {
  ...
  personId.value = "";
  personId.style.border = "solid 1px #dfdee0";
  displayId.textContent = "0000 0000 0000 0000";
  month.value = "";
  month.style.border = "solid 1px #dfdee0";
  displayMonth.textContent = "00";
  cvc.value = "";
  cvc.style.border = "solid 1px #dfdee0";
  displayCVC.textContent = "000";
  year.value = "";
  year.style.border = "solid 1px #dfdee0";
  displayYear.textContent = "00";
  personName.value = "";
  personName.style.border = "solid 1px #dfdee0";
